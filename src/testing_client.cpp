...
int test1(){
   ros::NodeHandle n;
   ros::ServiceClient client = n.serviceClient<staubliTX60::GetCartesian>("getCartesian");

   staubliTX60::GetCartesian srv1;
...
int test2(){
   ros::NodeHandle n;
   ros::ServiceClient client = n.serviceClient<staubliTX60::GetJoints>("getJoints");

   staubliTX60::GetJoints srv1;
...
void test3(){
   ...
   actionlib::SimpleActionClient<staubliTX60::SetJointsAction> ac("setJoints", true);
     ROS_INFO("Waiting for action server to start.");
     ac.waitForServer(); //will wait for infinite time
     staubliTX60::SetJointsGoal goal;
     goal.j = joints;
     ac.sendGoal(goal);
